...
- (void)viewDidLoad
{
    ...
    if ([self.levelSetName isEqualToString:@"set1"]||[self.levelSetName isEqualToString:@"set2"] ) {
        ...
        AnimatedPic1.animationImages = [NSArray arrayWithObjects:
                                        [UIImage imageNamed:@"toturial5.png"],
                                        [UIImage imageNamed:@"toturial6.png"],
                                        [UIImage imageNamed:@"toturial7.png"],nil];
        [AnimatedPic1 setAnimationRepeatCount:0];
        AnimatedPic1.animationDuration = 7;
        [AnimatedPic1 startAnimating];
