...
- (void)viewDidLoad
{
    ...
    _winningScore = [[levelDictionary objectForKey:_levelName] intValue];
    ...
    if([_levelSetName isEqualToString:@"set1"]){
    ...
    }else if([_levelSetName isEqualToString:@"set2"]){
        [_lbl1 setTextColor:[UIColor whiteColor]];
        [_lbl2 setTextColor:[UIColor whiteColor]];
        
        [_winScoreLbl setTextColor:[UIColor whiteColor]];
        [_currentScorelbl setTextColor:[UIColor whiteColor]];
        ...
        [_winScoreLbl setText:@""];
        [_currentScorelbl setText:@""];
