...
@implementation GameScene{
    ...
    float showAreaOfPolygonPercentage;
                ...
                if (ch != 0) {
                    ...
                    if([_levelSetName isEqualToString:@"set1"] || [_levelSetName isEqualToString:@"set2"]){
                        ...
                        if(pf1==1 && pf2==1){
                            ...
                            areaOfPolygonPercentage = 100 - ((((areaOfPolygonBefore -areaOfPolygonCurrent)/areaOfPolygonBefore)*100)*(100/(100 - _winningScore)));
...
-(void)addFixedObjects{
    ...
    fixedObject =  [[MovingObject alloc]initWithColor:[UIColor yellowColor] size:CGSizeMake(25, 25)];
...
-(void)set1Win{
    ...
    if((int)areaOfPolygonPercentage <=0){
        _changeScore(0);
        self.paused = YES;
...
-(void)fetchPlayerScore{
    ...
    if(levelSetDictionary == nil){
        ...
        levelSetDictionary = [[NSDictionary alloc] initWithContentsOfFile:plistLevel];
    }
...
-(void)updatePlayerScore{
    ...
    plistLevel = [rootPath stringByAppendingPathComponent:@"Player-score.plist"];
    levelSetDictionary = [[NSMutableDictionary alloc] initWithContentsOfFile:plistLevel];
    levelDictionary = [[NSMutableDictionary alloc] initWithDictionary:[levelSetDictionary objectForKey:self.levelSetName]];
    playerScores = [NSMutableArray arrayWithArray:[levelDictionary objectForKey:self.levelName]];
...
-(void)computeFinalScore{
    ...
    if([_levelSetName isEqualToString:@"set3"]){
        ...
        temp2 = powf(1/1.09,_finalTime)*100;
